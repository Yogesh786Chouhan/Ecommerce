...
const Products = () => {
    ...
    const isPriceFilterApplied = price[0] !== 0 || price[1] !== 25000 || category !== "" || ratings !== 0;
                ...
                <Fragment>
                    ...
                    <div className="products">
                        {products && products.length > 0 ? (
                            ...
                            <h2 className='noProducts'>Product Not Found</h2>
                        )}
                    </div>
                    ...
                    {!isPriceFilterApplied && productsCount > resultPerPage && (
